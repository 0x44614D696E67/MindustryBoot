...
/// 初始资源配给项
/// </summary>
public record struct LoadoutItem
{
...
/// 详细地图信息的 Tags 部分
/// </summary>
public record struct DetailedMapInfoTags
{
...
/// 地图上传者信息
/// </summary>
internal record struct WayzerUser
{
    [JsonPropertyName("name")]
    public string Name
    {
...
/// </summary>
internal record struct DetailedMapInfo
{
